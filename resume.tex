...
\section{Specialized Skills}
	...
	\vspace{-20pt} %% but why?
	\skillsEntry{Software}{Crosscore Embedded Studio, Audio Weaver, Allegro PCB Viewer, SIMPLIS/SIMetrix Simulator, LTspice XVII, Mentor Graphics DxDesigner, Linux CLI, git}
	\vspace{-12pt} %% but why?
